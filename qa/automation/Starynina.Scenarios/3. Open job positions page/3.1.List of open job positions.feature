...
Scenario: 3.1_01 User can choose one of job positions
	...
	Then the selected line should be highlighted in blue
...
Scenario Outline: 3.1_04 User can use the filter search check by competence - one competence
...
Scenario Outline: 3.1_05 User can use the filter search check by technologies - one technology
...
Scenario: 3.1_06 User can use the filter search check by competence - more than one competence
...
Scenario: 3.1_07 User can use the filter search check by technologies - more than one technology
...
Scenario: 3.1_08 User can use both filters by competence and technologies - one competence and one technology
	When user chooses one <competence> from the list of competencies
...
Scenario Outline: 3.1_09 User can use both filters by competence and technologies - more than one
...
Scenario: 3.1_10 User can update the page
