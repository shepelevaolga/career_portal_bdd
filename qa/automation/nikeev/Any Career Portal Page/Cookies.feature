...
Scenario: User can learn more about cookies using cookie pop-up
	...
	Then the message box with Cookies Settings should be displayed ('Necessary cookies' is required option)

Scenario: User can accept cookies using cookie pop-up and Cookies Settings box
	Given user saw a cookie pop-up at the bottom of the screen
	And clicked on 'Learn more' button
	And chose the cookies options using checkboxes in Cookies Settings box ('Necessary cookies' is required option)
	When user clicks on 'Submit Preferences' button
	Then Cookies Setting box disappears
	And cookie pop-up disappears

Scenario: User can doesn't accept cookies using cookie pop-up and Cookies Settings box
	Given user saw a cookie pop-up at the bottom of the screen
	And clicked on 'Learn more' button
	And saw Cookies Settings message box ('Necessary cookies' is required option)
...
Scenario Outline: User can configure cookies using Cookies Settings box on any portal page
	...
	And chose the cookies options using checkboxes in Cookies Settings message box ('Necessary cookies' is required option)
	When user clicks on 'Submit Preferences' button
