...
Scenario Outline: 2.1 Positive CV Tests
    When I fill "<Name>", "<Email>", "<Attach CV>", "<I agree>", "<Message>" fields with foolowing combination of values:
        ...
        |2 word latin letters | valid domain | .doc <10Mb  | not empty | not empty |
        |2 word latin letters | valid domain | .rtf <10Mb  | not empty | empty     |
        |2 word latin letters | valid domain | .docx <10Mb | not empty | not empty |
        |2 word latin letters | valid domain | .pdf <10Mb  | not empty | empty     |
