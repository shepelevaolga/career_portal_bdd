...
Scenario: User can send CV form
...
Scenario: 1.0_02 User inputs invalid length in the field "Name"
...
Scenario Outline: 1.0_03 User inputs invalid data in field "Name"
...
Scenario Outline: User inputs invalid data in field "Email"
...
Scenario: 1.0_04 User inputs invalid length in the field "Email"
...
Scenario: 1.0_05 User inputs  the maximum number of characters (70) in the field "Name"
...
Scenario: 1.0_06 User inputs  the maximum number of characters (70) in the field "Email"
...
Scenario: 1.0_12 User inputs 500 symbols in the field "Message"
...
Scenario: 1.0_13 User inputs 499 symbols in the field "Message"
...
Scenario: 1.0_14 User inputs  extra letter in the domain "com" in the field "Email"
...
Scenario: 1.0_15 User inputs only numbers before domain in "Email" field
When User inputs 111111@domain.com in the field "Email"
Then Field "Email" should be highlighted in red
But Field "Email" highlighted in green
And Error message does not appear

Scenario: 1_0_16 User inputs two "@" in "Email" field
...
Scenario Outline: 1.0_17 User attaches valid and invalid CV file with different sizes
