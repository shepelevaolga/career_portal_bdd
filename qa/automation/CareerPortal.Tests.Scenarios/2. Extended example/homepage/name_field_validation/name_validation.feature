...
@positive
Scenario Outline: 1.1.2 Validation with latin characters
...
@Positive
	Scenario Outline: 1.1.3. Validation with kirilica characters
...
@Positive
@tc003
	Scenario Outline: 1.1.4 Validation with latin and kirilica characters
	Given User in job position page
	...
	@Negative
	Scenario Outline: Validation with numbers 
	...
	@negative 
	Scenario Outline: Validation with special characters
	Given User clicked on <name_field> text field
...
@Boundary_testing
@Positive
Scenario: 1.1.5. Validation with max and min symbols
...
@Negative
Scenario Outline: Validation with  0 and 71 characters 
